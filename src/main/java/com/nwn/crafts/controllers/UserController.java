...
public class UserController {
    ...
    @Operation(summary = "Delete user", description = "Delete an existing user from his id")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete user", description = "Delete an existing user from his login")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully Deleted"),
            @ApiResponse(responseCode = "404", description = "Not found - No User was found for this login")
    })
